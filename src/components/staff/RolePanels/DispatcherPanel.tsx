 ...
 *
 * File-level:
 * Role-specific panel for dispatchers. Displays Nationality, Condition and Actions.
 */
 ...
 * @description Props for DispatcherPanel
 */
...
/**
 * DispatcherPanel
 * @description UI panel for dispatcher role. Age block removed.
 */
const DispatcherPanel: React.FC<DispatcherPanelProps> = ({ data, onAction }) => {
  /**
   * handle
