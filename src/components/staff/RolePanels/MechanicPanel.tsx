 ...
 *
 * File-level:
 * Role-specific panel for mechanics. Displays Nationality, Condition and Actions.
 */
...
/**
 * MechanicPanelProps
 * @description Props for MechanicPanel
 */
...
/**
 * MechanicPanel
 * @description UI panel for mechanic role. Age block removed.
 */
const MechanicPanel: React.FC<MechanicPanelProps> = ({ data, onAction }) => {
  /**
   * handle
